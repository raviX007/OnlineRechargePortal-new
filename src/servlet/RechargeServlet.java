...
public class RechargeServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest req,HttpServletResponse res) throws ServletException, IOException
	{
		...
		else
		{
			...
			{
				req.setAttribute("message","<h2 align='center' style='color:green;'>Recharge Done Successfully!</h2><script type='text/javascript'>alert('Recharge of RS. "+amount+" was successful on "+mobileno+".');</script>");
